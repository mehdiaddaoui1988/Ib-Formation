(() => {
    ...
    var lettresAReordonner: string;
    var nombreLettres: string;
    ...
    $("#surface-config").submit((e) => {
        ...
        nombreLettres = ($("#input-nombreLettres").val() as string);
    ...
    $("#surface-jeu").submit((e) => {
        ...
        var motTente = ($("#input-motTente").val() as string).toUpperCase();
    ...
    $("#btn-ff").click(() => {
        ...
        $.get("/anagramme/getReponses/" + lettresAReordonner).then((resultats: string[]) => {
