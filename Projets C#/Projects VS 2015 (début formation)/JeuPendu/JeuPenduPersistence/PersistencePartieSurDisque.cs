...
{
    public class PersistencePartieSurDisque : IPersistencePartie<Partie>
    {
        string path = @"C:\Data";
        ...
        public int Save(Partie obj, string nom)
        {
            ...
            monSerialiseur.WriteObject(streamVersFichier, obj);
        ...
        public void Update(int id, Partie obj)
        {
            // Rechercher le descripteur correspondant
            var descripteur = List().FirstOrDefault(c => c.Id == id);
            ...
            var monSerializer = new DataContractSerializer(typeof(Partie));
            monSerializer.WriteObject(streamVersFichier, obj);
            streamVersFichier.Close();
        }
    }
}
